...
def MainTaskExecution(query):
    ...
    elif "call" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "slide show" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    ...
    elif "cut" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "terminate" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "full" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "pause" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "game" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "alarm" in ReturnData:
        value=OpenExe(ReturnData)
        return value
    
    elif "mail" in ReturnData:
        value=OpenExe(ReturnData)
        return value
